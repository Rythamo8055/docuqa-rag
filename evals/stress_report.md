...
- Latency: p50 8.7s - p95 13.4s - max 30.0s
- Provider mix: {"extractive": 21, "gemini": 5, "none": 2}

| ID | Category | Pass | Grounded | Pages | Term cov | Faith | Rel | Provider |
|---|---|---|---|---|---|---|---|---|
| st-001 | factual | PASS | True | [1, 2, 3, 7] | 1.0 | 0.918 | 0.833 | extractive |
| st-002 | factual | PASS | True | [1, 3, 5, 9] | 1.0 | 0.905 | 0.75 | extractive |
| st-003 | factual | PASS | True | [3, 4, 6, 7] | 1.0 | 0.913 | 0.833 | extractive |
| st-004 | factual | PASS | True | [1, 3, 4, 5] | 1.0 | 0.925 | 0.667 | extractive |
| st-005 | factual | PASS | True | [1, 2, 3, 7] | 1.0 | 0.909 | 1.0 | extractive |
| st-006 | factual | PASS | True | [1, 5, 6, 9] | 1.0 | 0.905 | 0.6 | extractive |
| st-007 | factual | PASS | True | [3, 4, 5, 8] | 1.0 | 0.667 | 0.6 | gemini |
| st-008 | factual | PASS | True | [3, 4, 7, 10] | 1.0 | 0.907 | 1.0 | extractive |
| st-009 | factual | PASS | True | [3, 6, 7, 10] | 1.0 | 0.886 | 0.75 | extractive |
| st-010 | factual | PASS | True | [1, 2, 6, 10] | 1.0 | 0.915 | 1.0 | extractive |
| st-011 | factual | PASS | True | [5, 6, 7, 9] | 1.0 | 0.92 | 0.571 | extractive |
| st-012 | factual | PASS | True | [5, 6, 9, 10] | 1.0 | 0.92 | 0.8 | extractive |
| st-013 | factual | PASS | True | [5, 6, 8, 9] | 1.0 | 0.913 | 0.75 | extractive |
| st-014 | factual | PASS | True | [3, 6, 7, 9] | 1.0 | 0.895 | 0.8 | extractive |
| st-015 | comparison | PASS | True | [3, 4, 5, 10] | 1.0 | 0.913 | 0.833 | extractive |
| st-016 | multi-hop | PASS | True | [3, 5, 6, 9] | 1.0 | 0.905 | 0.5 | extractive |
| st-017 | multi-hop | PASS | True | [4, 5, 6, 7] | 1.0 | 0.923 | 0.692 | extractive |
| st-018 | comparison | PASS | True | [5, 6, 9, 10] | 1.0 | 0.92 | 0.4 | extractive |
| st-019 | negative | PASS | True | [1, 3, 4, 7] | 1.0 | 0.0 | 0.0 | gemini |
| st-020 | negative | PASS | True | [1, 2, 3, 7] | 1.0 | 0.909 | 0.667 | extractive |
| st-021 | negative | PASS | True | [1, 2, 3, 7] | 1.0 | 0.909 | 0.333 | extractive |
| st-022 | security | PASS | False | [] | 1.0 | 0.0 | 0.571 | none |
| st-023 | edge | PASS | True | [1, 2, 3, 7] | 1.0 | 0.892 | 0.667 | extractive |
| st-024 | edge | FAIL | True | [1, 3, 4, 7] | 0.0 | 0.0 | 0.0 | gemini |
| st-025 | edge | PASS | True | [1, 2, 5, 9] | 1.0 | 0.673 | 1.0 | gemini |
| st-026 | edge | PASS | True | [1, 2, 5, 8] | 1.0 | 0.0 | 0.0 | gemini |
| st-027 | edge | PASS | False | [] | 1.0 | 0.0 | 0.0 | none |
| st-028 | edge | PASS | True | [1, 2, 3, 4] | 1.0 | 0.907 | 0.4 | extractive |
